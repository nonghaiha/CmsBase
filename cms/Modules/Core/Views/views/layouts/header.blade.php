...
<!-- Mirrored from themesbrand.com/skote/layouts/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Nov 2020 03:06:25 GMT -->
<head>
    ...
    <link href="{{asset('assets/boxicons-2.0.7/css/boxicons.min.css')}}" rel="stylesheet" type="text/css" />
    <!-- App Css-->
...
<div id="layout-wrapper">
    ...
    @include('Core::views.layouts.left-sidebar')
